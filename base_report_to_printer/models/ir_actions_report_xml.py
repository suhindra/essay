...
class IrActionsReportXml(models.Model):
    ...
    max_print = fields.Integer(
        help='Max Print to server.', string='Max Print', default=1)

    print_limit_exception = fields.Many2one(comodel_name='res.users', help='Print Limit Exception to server.', string='Print Limit Exception')
